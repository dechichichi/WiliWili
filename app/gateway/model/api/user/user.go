...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_ProfileReq[fieldId]))
}
...
func (p *UserAvatarGetReq) GetUserId() (v int64) {
	return p.UserId
}
...
func (p *UserAvatarGetReq) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
	var issetUserId bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserAvatarGetReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UserAvatarGetReq[fieldId]))
}

func (p *UserAvatarGetReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserAvatarGetReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UserAvatarGetReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserAvatarGetReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("userId", thrift.I64, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.UserId); err != nil {
...
func (p *UserAvatarGetResp) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserAvatarGetResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UserAvatarGetResp[fieldId]))
}

func (p *UserAvatarGetResp) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserAvatarGetResp) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UserAvatarGetResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserAvatarGetResp) writeField1(oprot thrift.TProtocol) (err error) {
...
type UserService interface {
	...
	GetAvatar(ctx context.Context, req *UserAvatarGetReq) (r *UserAvatarGetResp, err error)
}
...
func (p *UserServiceClient) GetAvatar(ctx context.Context, req *UserAvatarGetReq) (r *UserAvatarGetResp, err error) {
...
type UserServiceGetAvatarArgs struct {
	Req *UserAvatarGetReq `thrift:"req,1"`
}
...
var UserServiceGetAvatarArgs_Req_DEFAULT *UserAvatarGetReq

func (p *UserServiceGetAvatarArgs) GetReq() (v *UserAvatarGetReq) {
	if !p.IsSetReq() {
...
type UserServiceGetAvatarResult struct {
	Success *UserAvatarGetResp `thrift:"success,0,optional"`
}
...
var UserServiceGetAvatarResult_Success_DEFAULT *UserAvatarGetResp

func (p *UserServiceGetAvatarResult) GetSuccess() (v *UserAvatarGetResp) {
	if !p.IsSetSuccess() {
