...
type VideoLike struct {
	...
	VideoID   string    `json:"video_id" gorm:"primaryKey;autoIncrement:false"`
...
type CommentLike struct {
	UserID    string    `json:"user_id" gorm:"primaryKey;autoIncrement:false"`
	CommentID string    `json:"comment_id" gorm:"primaryKey;autoIncrement:false"`
	CreatedAt time.Time `json:"created_at" gorm:"autoCreateTime"`
	UpdatedAt time.Time `json:"updated_at" gorm:"autoUpdateTime"`
}
...
type LikeCount struct {
	ObjectID   string `json:"object_id" gorm:"primaryKey;autoIncrement:false"`
