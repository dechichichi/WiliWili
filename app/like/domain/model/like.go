...
type VideoLike struct {
	UserID    int64     `json:"user_id" gorm:"table:video_likes;primaryKey;autoIncrement:false"`
...
type CommentLike struct {
	UserID    int64     `json:"user_id" gorm:"table:comment_likes;primaryKey;autoIncrement:false"`
...
type LikeCount struct {
	ObjectID   int64 `json:"object_id" gorm:"table:like_counts;primaryKey;autoIncrement:false"`
